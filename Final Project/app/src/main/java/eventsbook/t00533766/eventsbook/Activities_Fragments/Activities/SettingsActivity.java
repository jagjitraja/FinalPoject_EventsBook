...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    //SETTINGS ACTIVITY TO UPDATE USER NAME AND EMAIL
    static Preference.OnPreferenceChangeListener preferenceChangeListener = new Preference.OnPreferenceChangeListener() {
        @Override
            ...
            if (preference instanceof EditTextPreference) {
                ...
                if (preference.getKey().equals("user_display_name")) {
                    ...
                    UserProfileChangeRequest userProfileChangeRequest = new UserProfileChangeRequest.Builder()
                            .setDisplayName(((EditTextPreference) preference).getText()).build();
                        ...
                        firebaseUser.updateProfile(userProfileChangeRequest).
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Utils.showToast(preference.getContext(),"UserName Updated");
                                    Log.d(TAG, "onComplete: PASSED");
                                }else {

                                    Utils.showToast(preference.getContext(),"Failed to update UserName");
                ...
                }else if (preference.getKey().equals("user_email_address")) {

                    String newEmail = ((EditTextPreference) preference).getEditText().getText().toString();
